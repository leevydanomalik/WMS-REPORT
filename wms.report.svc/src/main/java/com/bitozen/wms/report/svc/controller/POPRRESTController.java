...
public class POPRRESTController {
   ...
   public byte[] generatePOPRReportCSV(@RequestParam(value = "reportFormat", required = false) FileExtention reportFormat) throws GenericException{
       Map <String, Object> params = new HashMap<>();
       ByteArrayOutputStream poPr;
       reportService.setRptResourcePrefix("/report/");
       poPr = (ByteArrayOutputStream) reportService.showReportJdbcDataSourceExportToPdfTxtCsvXls(FileExtention.CSV, POPR_CSV, params);
       
    /*validate object*/
    Validate.notNull(poPr);
    
    /*get the byte*/
    byte[] dataStream = poPr.toByteArray();
