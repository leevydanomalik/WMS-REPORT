...
public class BPPDspRESTController {
    
    
     private final String BPPDSP_JASPER = "BPPDSP.jasper";
    
    @Autowired
    ReportService reportService;
    
    @RequestMapping(value = "/bppDsp/{postoNumber}/{lostoNumber}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_PDF_VALUE)
    public ResponseEntity<?> generateBPPDsp(@PathVariable("postoNumber") String postoNumber,@PathVariable("lostoNumber") String lostoNumber) {
        ...
        try {
            os = (ByteArrayOutputStream) reportService.showReportJdbcDataSourceExportToPdfTxtCsvXls(null, BPPDSP_JASPER, params);
